...
export default function Dashboard() {
  ...
  return (
    <div className="px-4 pt-6 max-w-lg mx-auto">
      ...
      <Link to="/import" className="block mb-6">
        <div className="card bg-blue-500/10 border-blue-500/40 hover:bg-blue-500/20 active:bg-blue-500/30 transition-colors cursor-pointer">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-semibold text-white text-lg">Import Students</p>
              <p className="text-slate-400 text-sm">Upload a CSV roster from Google Classroom</p>
            </div>
            <svg className="w-5 h-5 text-slate-500 ml-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
